...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("TO DO APPLICATION");
    ...
    try {
        int seconds = Integer.parseInt(jTextField1.getText()); // Replace jTextField1 with your actual text field name
        TO_DO_APPLICATION.ReminderManager.startReminder(seconds); // Call your logic
